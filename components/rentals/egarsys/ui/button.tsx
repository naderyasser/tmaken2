// Ported from egarsys src/components/ui/button.tsx (Tailwind v4 → v3 adapted:
// shadow-xs → shadow-sm, default height h-9). Reproduced so the dashboard's
// header CTAs match egarsys's button metrics exactly.
