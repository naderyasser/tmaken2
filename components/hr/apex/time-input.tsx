...
const BASE_CLASS = 'h-10 w-24 rounded-none border bg-white text-center text-[16px] font-medium text-black outline-none focus:border-[var(--apex-blue)] disabled:bg-slate-100 disabled:text-slate-400'
